    ...
    public static void main(String[] args) {
        ...
        while(t-- > 0){
            ...
            while (l >= 0){
                char ch = st.charAt(l);
                if(ch == '0') {
                    System.out.println((Integer.parseInt(st.substring(l-2 , l))) - 1);
//                    ans = ((char)('a' + (Integer.parseInt(st.substring(l-2 , l))) - 1)) + ans;
                    l = l - 3;
                    System.out.println(ans + " ---> " + l);
                }
                else {
                    System.out.println((Integer.parseInt(String.valueOf(t)) - 1));
//                    ans =  ((char)('a' + (Integer.parseInt(String.valueOf(t)) - 1))) + ans ;
                    l = l-1;
                    System.out.println(ans + " ---> " + l);
                }
            }
